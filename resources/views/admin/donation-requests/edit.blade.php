            ...
            <div class="row g-4"> <!--begin::Col-->
                <div class="col-12">
                    ...
                    <div class="card  card-outline mb-4"> <!--begin::Header-->
                        ...
                        <form class="needs-validation" method="post" action="{{ route("admin.clients.update",$model->id) }}"
                            ...
                            <div class="card-body"> <!--begin::Row-->
                                <div class="row g-3"> <!--begin::Col-->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="date" name="b_o_d" value="{{  $model->b_o_d }}"  class="form-control"
                                               id="validationCustom01" required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="date" name="last_donation_date" value="{{  $model->last_donation_date }}"  class="form-control"
                                               id="validationCustom01" required>
                                    ...
                                    <div class="col-md-12"><label for="validationCustom01" class="form-label">Cities</label>
                                        <select class="form-control" name="city_id">
                                            @foreach($cities->all() as $city)
                                                <option value="{{$city->id}}" @selected($city->id == $model->city_id)>
                                                    {{$city->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12"><label for="validationCustom01" class="form-label">Blood Types</label>
                                        <select class="form-control" name="blood_type_id">
                                            @foreach($bloodTypes->all() as $bloodType)
                                                <option value="{{$bloodType->id}}" @selected($bloodType->id == $model->blood_type_id)>
                                                    {{$bloodType->name}}
                                                </option>
                                            @endforeach
                                        </select>
